...
const DashboardAgentCard: React.FC<DashboardAgentCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <p
        className={`text-sm ${
          selected ? "text-gray-300" : "text-gray-600 dark:text-gray-300"
        }`}
      >
        {description}
      </p>
...
const DashboardContent = ({
  ...
  const dashboardCards = [
    {
      ...
      description:
        "Create flow code from flow specifications and flow diagrams",
    ...
    },
    {
      ...
      description:
        "Connect with MuleSoft developers to solve problems together",
    ...
    },
    {
      ...
      description:
        "Get help with MuleSoft, DataWeave, and API development questions",
  ...
  const displayedCards =
    filteredAgents?.length > 0 ? filteredAgents : dashboardCards;
      ...
      <div className="flex h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-950 dark:to-gray-900 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden relative">
          ...
          <div className="relative z-10 flex-1 overflow-auto">
            ...
            {currentPage === "taskView" && selectedTask && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 0.3 }}
            ...
            {currentPage === "exchangeItem" && selectedExchangeItemId && (
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 0.3 }}
          ...
          <CodingAssistantDialog
            ...
            trigger={
              <button
                data-dialog-trigger="coding-assistant"
                className="hidden"
              ></button>
            }
          />
